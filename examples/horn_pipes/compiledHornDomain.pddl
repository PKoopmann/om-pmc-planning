...
(:constants
  dd de df dg pipecg pipegc wallbb pipegb pipecc pipecd ea eb ec ed ee aa ef ab ac eg ad ae af ag pipedf wallcb pipede fa fb fc fd ba fe bb ff fg bc bd be auv bf bg mineef walldd walldb walldc pipeee ga gb gc gd ca ge cb gf cc gg cd ce cf cg pipebg pipefc wallab pipefd da db dc - object)
(:predicates
...
(:derived (DATALOG_MEDIUMRISKPIPE ?x0 - object)
          (or (AUX12 ?x0) (mediumriskpipe ?x0)))
(:derived (DATALOG_COVERED ?x0 - object)
          (or (AUX13 ?x0) (AUX14 ?x0) (AUX15 ?x0)))
