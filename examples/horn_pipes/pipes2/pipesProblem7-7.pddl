(define (problem pipes_problem)
	(:domain pipes)
	(:objects aa ab ac ad ae af ag auv ba bb bc bd be bf bg ca cb cc cd ce cf cg da db dc dd de df dg ea eb ec ed ee ef eg fa fb fc fd fe ff fg ga gb gc gd ge gf gg pipeBA pipeBB pipeCB pipeDB pipeEB pipeED pipeFD tankFA tankFC tankFE tankLarge valveBD valveEA valveEC valveEE valveGD wall 
)
	(:init
		(nextTo aa ab)
		(nextTo aa ba)
