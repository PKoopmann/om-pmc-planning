(define (problem pipes_problem)
	(:domain pipes)
	(:objects aa ab ac ad ae af ag ba bb bc bd be bf bg ca cb cc cd ce cf cg da db dc dd de df dg ea eb ec ed ee ef eg fa fb fc fd fe ff fg ga gb gc gd ge gf gg auv tankEE valveAC valveDC valveEF valveGC wallAH wallBA wallDD wallID pipeCC pipeCD pipeCE pipeCF pipeEC pipeFC pipeHC pipeIC pipeJC
)
	(:init
		(nextTo aa ab)
		(nextTo aa ba)
